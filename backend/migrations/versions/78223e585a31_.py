...
Revision ID: 78223e585a31
Revises: 
Create Date: 2020-11-29 20:28:49.540217
...
def upgrade():
    ...
    sa.Column('state', sa.Enum('Nan', 'Pending', 'Reading', 'Finished', 'Dropped', name='state_types'), nullable=False),
